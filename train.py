...
from src.policy import Policy, action_pt_to_env, DiscretePolicy
from src.critic import Critic
from src.rollout import rollout_episode, get_returns, get_gae_advantages
...
def train_ppo(
    ...
    print(
        f"[INFO] Training with gamma={gamma}, actor_lr={actor_lr}, critic_lr={critic_lr}, timesteps={timesteps}, n_epochs={n_epochs}"
    )
    save_json(
        {
            "gamma": gamma,
...
if __name__ == "__main__":
    ...
    train_ppo(
        ...
        timesteps=256,
        n_epochs=2000,
        save_dir="./training_runs/ppo/mook",
        n_envs=32,
        log_every=25,
        eval_every=100,
        n_updates=2,
